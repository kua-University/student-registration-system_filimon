...
class AdminCourseRegistrationTest extends TestCase
{
    use RefreshDatabase;

    /**
     * Test that an admin creates a course, a student views available courses,
     * enrolls in a course, completes the payment, and receives a receipt.
     */
    public function test_admin_creates_course_and_student_registers()
    {
        ...
        // Verify the course fee of the created course in the database
